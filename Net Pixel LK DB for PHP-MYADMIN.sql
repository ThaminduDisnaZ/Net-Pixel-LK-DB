...
--
-- Host: localhost    Database: netpixel
-- ------------------------------------------------------
...
CREATE TABLE `discode` (
  ...
  `dis` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `code` varchar(145) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `user_img` (
  ...
  `path` varchar(145) COLLATE utf8mb4_general_ci NOT NULL,
  `user_id` int NOT NULL,
...
-- Dump completed on 2024-06-10 19:45:19
