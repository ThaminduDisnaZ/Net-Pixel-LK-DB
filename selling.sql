...
-- Dumping data for table selling.brand: ~1 rows (approximately)
...
-- Dumping data for table selling.cart: ~1 rows (approximately)
...
-- Dumping data for table selling.category: ~1 rows (approximately)
...
-- Dumping data for table selling.cpu: ~1 rows (approximately)
...
-- Dumping data for table selling.discode: ~0 rows (approximately)
...
-- Dumping data for table selling.display: ~1 rows (approximately)
...
-- Dumping data for table selling.gpu: ~1 rows (approximately)
...
-- Dumping data for table selling.model: ~1 rows (approximately)
...
-- Dumping data for table selling.orders: ~0 rows (approximately)
...
-- Dumping data for table selling.payment_status: ~0 rows (approximately)
...
-- Dumping data for table selling.product: ~1 rows (approximately)
...
-- Dumping data for table selling.recent: ~1 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=48210052 DEFAULT CHARSET=utf8mb3;

-- Dumping data for table selling.user: ~1 rows (approximately)
INSERT INTO `user` (`user_id`, `fname`, `lname`, `email`, `mobile`, `no`, `street`, `city_id`, `status_id`, `password`, `otp`, `uev_id`) VALUES
	(48210051, 'Thamindu', 'Disna', 'thamindudisna121@gmail.com', '0768084855', '', 'Asgiriya', 5, 1, '12345', '6660991c9c44d', 1);
...
-- Dumping data for table selling.user_img: ~1 rows (approximately)
...
-- Dumping data for table selling.watchlist: ~1 rows (approximately)
